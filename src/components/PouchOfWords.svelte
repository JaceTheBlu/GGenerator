...
<div class="flex-col">
	<div class="flex">
		<input
			class=" bg-slate-800/50 flex-grow w-full focus:outline-none md:w-3/4 rounded-md mr-2 pl-2"
			type="text"
		...
		<button
			class="bg-blue-500 flex-shrink-0 w-full md:w-auto text-white rounded-md px-4 py-2"
			on:click={submit}
			>Submit
		</button>
	</div>
